...
![](images/clipboard-731790774.jpeg)
...
![](images/clipboard-2481209428.jpeg)
...
The statistical tests that the authors used are linear regression analysis and t-test. They use these to evaluate the body weight (W) and total length (L) relationships of 47 fish species. These tests calculate regression coefficients and the coefficient of determination to check if species show isometric or allometric growth. The summary table and histogram in the article are used to display the distribution of these growth types and the biological condition of native vs invasive populations.![](images/clipboard-3404324976.png)
